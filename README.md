...
|-------|----------------------------|--------------------------------------------------|-----------|
| 2026  | B.Tech in Computer Science | College of Engineering & Management, Kolaghat   | 7.0 CGPA  |
...
### Final Year Project – *Sentiment Analysis of Social Media Posts* (2024–25)
- Built a sentiment classification system using **Python + NLP**
...
- **Event Coordinator, Tech Fest**
  - Hosted 10 guest speakers; managed audience of 10,000+
  - Secured sponsorships from 10+ companies

- **Team Captain**
  - Led team of 20 players to gold medal in an inter-college tournament
